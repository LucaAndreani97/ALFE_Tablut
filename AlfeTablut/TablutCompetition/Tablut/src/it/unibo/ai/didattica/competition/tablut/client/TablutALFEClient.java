...
//	private int timeout;
//	
//	public TablutALFEClient(String player, String name, int timeout, String ipAddress) throws UnknownHostException, IOException {
...
//		
//		if (args.length < 3) {
//			System.out.println("Usage: client.jar WHITE/BLACK timeout ipAddress");
//			System.exit(-1);
//		}
//		
//        if (args.length < 1) {
...
//        System.out.println("Server: " + this.ipAddress);
//        
//        while (true) {
//
